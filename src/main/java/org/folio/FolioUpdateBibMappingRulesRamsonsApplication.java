...
public class FolioUpdateBibMappingRulesRamsonsApplication implements CommandLineRunner {

	@Autowired
	private UpdateMappingRulesService service;

	public static void main(String[] args) {
		SpringApplication.run(FolioUpdateBibMappingRulesRamsonsApplication.class, args);
	}
